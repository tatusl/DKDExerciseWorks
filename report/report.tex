...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{scatter_plot_density_sulphates}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{scatter_plot_pH_alcohol}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{scatter_plot_residual_sugar_free_sulfur_dioxide}
